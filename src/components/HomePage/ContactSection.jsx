  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-b from-mountain-peak/20 to-mountain-shadow/50">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-light text-mountain-shadow mb-4">Get in Touch</h2>
          <div className="w-24 h-1 bg-mountain-shadow/30 mx-auto mb-6" />
          <p className="text-mountain-shadow/80 max-w-xl mx-auto">
